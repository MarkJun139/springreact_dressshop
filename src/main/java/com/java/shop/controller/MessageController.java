...
public class MessageController {
    ...
    public MessageController() {
        ...
        this.messageService = NurigoApp.INSTANCE.initialize("NCSGNWB1YYIAJSCL", "PKZOZGO5XVLQHOUPJKNT6APGRSYQ4BD5", "https://api.coolsms.co.kr");
    }
    ...
    public SingleMessageSentResponse sendOne(@RequestBody String phone) {
